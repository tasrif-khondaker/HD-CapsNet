...
|    Mod-3.1    |  Top-Down <br />[Coarse-to-Fine] |                     8D                     | 32D>16D>8D <br />(Coarse>Medium>FINE) <br /> use   skip connections using concatination <br /> Concatenate([P_{caps},   S_{coarse}])>input for S_{medium} <br /> Concatenate([P_{caps},   S_{medium}])>input for S_{fine} |   Hinge loss (Margin Loss) **With** <br />Consistency ($L_{cons}$)  |
|    Mod-3.2    |  Top-Down <br />[Coarse-to-Fine] |                     8D                     | 32D>16D>8D <br />(Coarse>Medium>FINE) <br /> use   skip connections using concatination <br /> Concatenate([P_{caps},   S_{coarse}])>input for S_{medium} <br /> Concatenate([P_{caps},   S_{medium}])>input for S_{fine} | Hinge loss (Margin Loss) **Without** <br />Consistency ($L_{cons}$) |
