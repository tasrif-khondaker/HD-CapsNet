...
**HERE:**
    - *HD-CapsNet $~\dagger$* denotes HD-CapsNet model without Consistency Loss (Lc).
    - *HD-CapsNet $~\ddagger$* denotes HD-CapsNet model without the skip connections between the secondary capsule layers.
